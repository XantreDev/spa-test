...
export const setFavoriteRequests =
    (states: SearchState[]) => (dispatch: RootDispatch) => {
        dispatch({
...
export const updateFavoriteRequest =
    (state: SearchState, index: number) => (dispatch: RootDispatch) => {
        dispatch({
...
export const pushFavoriteRequest =
    (state: SearchState) => (dispatch: RootDispatch) => {
        dispatch({
...
export const removeFavoriteRequest =
    (index: number) => (dispatch: RootDispatch) => {
        dispatch({

...
const useCacheFavorites = () => {
    ...
    const searchState: searchStateType = useSelector(
        (state: RootState) => state.searchState
    );
    const lastSearchState: searchStateType = useSelector(
    ...
    useEffect(() => {
        ...
        if (
            ...
            isInFavoritesAndHaveResult(favorites, lastSearchState)
        ) {
        ...
        if (
            ...
            !tryResult &&
            searchState !== null &&
            isInFavoritesAndHaveResult(favorites, searchState)
        ) {

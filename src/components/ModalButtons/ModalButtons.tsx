...
const ModalButtons: React.FC<{ typeOfModal: modalType }> = ({
    typeOfModal,
}) => {
    const submitButtonCaption =
        typeOfModal === "push" ? "Сохранить" : "Изменить";
    const discardButtonCaption =
        typeOfModal === "push" ? "Не сохранять" : "Не изменять";

import HeadButton, {
    buttonStatusType,
} from "../../../UI/HeaderButton/HeaderButton";
...
const Navigation = () => {
    ...
    const searchStatus: buttonStatusType =
        history.pathname === searchPath.pathname ? "active" : "inactive";
    const favoriteStatus: buttonStatusType =
        history.pathname === favoritePath.pathname ? "active" : "inactive";
    ...
    return (
        <div className={styles.navigation}>
            ...
            <HeadButton
                link={favoritePath.pathname}
                type="favorite"
                statusType={favoriteStatus}
            >
                Избранное
            </HeadButton>
        </div>
